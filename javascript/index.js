...
function runway() {
    ...
    let desc;
    (function (desc) {
        desc[desc["neon extravaganza."] = 0] = "neon extravaganza.";
        desc[desc["animal print."] = 1] = "animal print.";
        desc[desc["glitter and glam."] = 2] = "glitter and glam.";
        desc[desc["vintage Hollywood."] = 3] = "vintage Hollywood.";
        desc[desc["futuristic chic."] = 4] = "futuristic chic.";
        desc[desc["under the sea."] = 5] = "under the sea.";
        desc[desc["royal elegance."] = 6] = "royal elegance.";
        desc[desc["cosmic fantasy."] = 7] = "cosmic fantasy.";
        desc[desc["ballerina beauty."] = 8] = "ballerina beauty.";
        desc[desc["gothic glam."] = 9] = "gothic glam.";
        desc[desc["femme fatale."] = 10] = "femme fatale.";
        desc[desc["space cowgirl."] = 11] = "space cowgirl.";
        desc[desc["masquerade mystery."] = 12] = "masquerade mystery.";
        desc[desc["vintage circus."] = 13] = "vintage circus.";
        desc[desc["tropical paradise."] = 14] = "tropical paradise.";
        desc[desc["sci-fi fantasy."] = 15] = "sci-fi fantasy.";
        desc[desc["cabaret diva."] = 16] = "cabaret diva.";
        desc[desc["modern art."] = 17] = "modern art.";
        desc[desc["rock star rebellion."] = 18] = "rock star rebellion.";
        desc[desc["art deco elegance."] = 19] = "art deco elegance.";
        desc[desc["pajama party."] = 20] = "pajama party.";
        desc[desc["carnival queen."] = 21] = "carnival queen.";
        desc[desc["harlequin."] = 22] = "harlequin.";
        desc[desc["whimsical woodland."] = 23] = "whimsical woodland.";
        desc[desc["mermaid magic."] = 24] = "mermaid magic.";
        desc[desc["futuristic warrior."] = 25] = "futuristic warrior.";
        desc[desc["rockabilly style."] = 26] = "rockabilly style.";
        desc[desc["sassy superhero."] = 27] = "sassy superhero.";
        desc[desc["glamorous vampire."] = 28] = "glamorous vampire.";
        desc[desc["dreamy pastels."] = 29] = "dreamy pastels.";
        desc[desc["theater of the absurd."] = 30] = "theater of the absurd.";
        desc[desc["bold stripes."] = 31] = "bold stripes.";
        desc[desc["retro futurism."] = 32] = "retro futurism.";
        desc[desc["sultry cabaret."] = 33] = "sultry cabaret.";
        desc[desc["trendy athleisure."] = 34] = "trendy athleisure.";
        desc[desc["cutesy kawaii."] = 35] = "cutesy kawaii.";
        desc[desc["spooky chic."] = 36] = "spooky chic.";
        desc[desc["festival vibes."] = 37] = "festival vibes.";
        desc[desc["chic punk."] = 38] = "chic punk.";
        desc[desc["artistic abstraction."] = 39] = "artistic abstraction.";
        desc[desc["golden goddess."] = 40] = "golden goddess.";
        desc[desc["edgy leather."] = 41] = "edgy leather.";
        desc[desc["serene zen."] = 42] = "serene zen.";
        desc[desc["daring cutouts."] = 43] = "daring cutouts.";
        desc[desc["lush florals."] = 44] = "lush florals.";
        desc[desc["mixed media madness."] = 45] = "mixed media madness.";
        desc[desc["the art of layering."] = 46] = "the art of layering.";
        desc[desc["fabulous furs."] = 47] = "fabulous furs.";
        desc[desc["celestial glamour."] = 48] = "celestial glamour.";
        desc[desc["fairytale whimsy."] = 49] = "fairytale whimsy.";
        desc[desc["tacky tourist."] = 50] = "tacky tourist.";
    })(desc || (desc = {}));
    runwayScreen.createParagraph("The queens will bring it to the runway!");
    if (currentCast.length > 4)
        runwayScreen.createParagraph("The theme is: " + desc[randomNumber(0, 50)]);
